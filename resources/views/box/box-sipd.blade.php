...
<div class="box box-widget widget-user">
        ...
        <div class="widget-user-header bg-yellow">
          ...
          <h5 class="widget-user-desc">RKPD - {{$data['tahun']}} - VIA API</h5>
        </div>
        ...
        <div class="box-footer">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="description-block">
                <h5 class="description-header"><a href="{{route('sipd.rkpd',['tahun'=>$data['tahun']])}}" class="btn btn-default">DETAIL</a></h5>
